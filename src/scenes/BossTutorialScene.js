...
class BossTutorialScene extends Phaser.Scene {
    constructor(config) {
        super("BossTutorialScene");
        this.copy = window.CONFIG.boss_tutorialpopup;
    }
    ...
    finishTutorial () {
      ...
      this.scene.stop('BossTutorialScene');
    }
}

export default BossTutorialScene;